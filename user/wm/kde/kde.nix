...

{
  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "dolphinrc"."General"."EditableUrl".value = true;
      "dolphinrc"."General"."ShowFullPath".value = true;
      "dolphinrc"."General"."SplitView".value = true;
      ...
      "kdeglobals"."General"."BrowserApplication".value = "chromium-browser.desktop";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{098d3549-5ae0-470d-8326-b69ed52a3109}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{6e518ea1-3d7a-443c-b331-90e7442e64d2}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{99845e24-3ffe-457c-a4db-fc7e9488dd07}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{a4865de9-3ec7-4d1d-843a-9bfc5288df25}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{83eb2fa7-a717-4c14-abb1-e89b9fedcb53}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{fb96005f-57ed-4f15-8466-a3b8a820277c}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{a5138829-4be5-46aa-b42c-58d6afb5d197}";
      ...
      "kservicemenurc"."Show"."kdiff3fileitemaction".value = true;
      ...
      "kwinrc"."Desktops"."Id_1".value = "389f9443-6b4c-451c-80fd-c20c8d74ae41";
      ...
      "plasma-localerc"."Formats"."LC_MEASUREMENT".value = "en_AE.UTF-8";
      "plasma-localerc"."Formats"."LC_MONETARY".value = "en_AE.UTF-8";
      "plasma-localerc"."Formats"."LC_PAPER".value = "en_AE.UTF-8";
      "plasma-localerc"."Formats"."LC_TIME".value = "en_AE.UTF-8";
